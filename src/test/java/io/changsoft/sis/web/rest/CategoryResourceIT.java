...
import io.changsoft.sis.domain.Category;
import io.changsoft.sis.repository.CategoryRepository;
import io.changsoft.sis.service.dto.CategoryDTO;
import io.changsoft.sis.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).code(DEFAULT_CODE).description(DEFAULT_DESCRIPTION).deleted(DEFAULT_DELETED);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).code(UPDATED_CODE).description(UPDATED_DESCRIPTION).deleted(UPDATED_DELETED);
        return category;
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).code(UPDATED_CODE).description(UPDATED_DESCRIPTION).deleted(UPDATED_DELETED);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).code(UPDATED_CODE).description(UPDATED_DESCRIPTION).deleted(UPDATED_DELETED);

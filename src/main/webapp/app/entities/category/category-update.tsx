...
export const CategoryUpdate = (props: ICategoryUpdateProps) => {
  ...
  const { description } = categoryEntity;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="changsoftSisApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="changsoftSisApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="category-name">
                  <Translate contentKey="changsoftSisApp.category.name">Name</Translate>
                </Label>
                <AvField
                  id="category-name"
                  data-cy="name"
              ...
              <AvGroup>
                <Label id="codeLabel" for="category-code">
                  <Translate contentKey="changsoftSisApp.category.code">Code</Translate>
                </Label>
                <AvField
                  id="category-code"
                  data-cy="code"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="category-description">
                  <Translate contentKey="changsoftSisApp.category.description">Description</Translate>
                </Label>
                <AvInput id="category-description" data-cy="description" type="textarea" name="description" />
              </AvGroup>
              <AvGroup check>
                <Label id="deletedLabel">
                  <AvInput id="category-deleted" data-cy="deleted" type="checkbox" className="form-check-input" name="deleted" />
                  <Translate contentKey="changsoftSisApp.category.deleted">Deleted</Translate>
                </Label>
              </AvGroup>

package io.changsoft.sis.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.changsoft.sis.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.changsoft.sis.repository.UserRepository.USERS_BY_EMAIL_CACHE);
